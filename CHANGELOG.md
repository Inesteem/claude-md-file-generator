...
- Auto-migration: first create/edit/delete copies bundled modules to user config dir transparently
- Visual distinction between bundled and user-defined modules (Source column in table, `*` prefix in selection, `source` field in JSON)
